...
export const Header: React.StatelessComponent = () => {
  return(
    <header className={css.header}>
      ...
      <a className={css.link} href="https://github.com/Sophmrs/lifelike"><p className={css.subtitle}><img alt="GitHub logo" className={css.subtitleLogo} src={github}/>About and Source</p></a>
    </header>
  );
}